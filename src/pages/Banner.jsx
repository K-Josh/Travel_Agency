...
const Banner = () => {
  ...
  return (
    <div className="relative py-3 lg:py-2 mb-10 lg:min-h-screen ">
      <Flex justifyContent={"center"} p={{base:3, md:6}} >
        ...
        <Flex direction={{ base: 'column', md: 'row' }} gap={{base:8, md:22}} alignItems={{base:'center', md:'center'}} className="lg:space-x-[5rem]" >
            <VStack alignItems={{base:'center', md:'flex-start'}} gap={{md:6}}>
                ...
                <Text w={{base:'20rem',sm:'24rem',md:'24rem'}} mb={{base:2, md:6}} >
      ...
      {/* ..... */}
        <Flex justifyContent={"center"} alignItems={'center'} p={{base:2, md:8}} direction={{base:'column',md: 'row' }} >
          <Box bg={'white'} color={"black"} p={{base:2, md:3}}rounded={'md'} w={{sm:'24rem', md:'32rem'}}>
             <Flex gap={{base:2, sm:6, md:7}} alignItems={'center'} >
