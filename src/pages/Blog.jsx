  ...
  <>
    <div className="relative lg:max-h-screen lg:mt-[0.4rem] mb-[2rem]">
      ...
      <BlogSection />
       ...
       {/* box */}
       <Box className="bg-primary-orange" rounded={'md'} w={{base:'18rem', md:'39rem'}} h={{base:'8rem', md:'12rem'}}  p={1}>
        <Flex justifyContent={'space-between'}>
            <Flex alignItems={'center'}>
             <Image src="/Images/circles.png"
               w={{base:'7rem',md:'12rem'}}
               position={'absolute'}
               top={{base:'100.9rem',md:'27.7rem'}}
               right={{base:'11.2rem'}}
              />
               <Flex justifyContent={'center'}>
                <VStack direction={'column'} >
                 ...
                 <Input color={'black'} w={{base:'12rem',md:'20rem',}} h={{base:'2rem',md:'2.9rem'}} type={'email'} bg={'white'} position={'absolute'} top={{base:'103rem',md:'31.5rem'}} right={{base:'4rem',md:'30rem'}}>
                 </Input>
