...
const ToDo = () => {
  return (
  <>
    <Flex justifyContent={'center'} mb={{base:'4rem'}}>
     <div className="flex items-center lg:max-h-screen" >
       ...
       <VStack  direction={['column',]}  alignItems={{base:'center',}} gap={{base:7, md:4}}>
        ...
        <Box pl={{base:'1rem',md:'8rem'}} className="mx-[12rem]"> 
          <Image 
        ...
        <Text fontSize={{base:'sm', md:'md'}}  className="text-center w-[20rem] lg:w-[24rem]">We ensure that you’ll embark on a perfectly planned, safe vacation at a price you can afford. </Text>
         {/* cards */}
